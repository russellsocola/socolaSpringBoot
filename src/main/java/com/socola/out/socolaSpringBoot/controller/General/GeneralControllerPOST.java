...
public class GeneralControllerPOST {
    ...
    public String saveAlmacen(@RequestBody String jsonAlmacen)throws JsonProcessingException {
    ...
    public String saveFactura(@RequestBody String jsonFactura) throws JsonProcessingException {
    ...
    public String saveFichaTecnica(@RequestBody String jsonFichaTecnica) throws JsonProcessingException {
    ...
    public String saveInventario(@RequestBody String jsonInventario) throws JsonProcessingException {
    ...
    public String savePago(@RequestBody String jsonPago) throws JsonProcessingException {
        Pago pago = objectMapper.readValue(jsonPago, Pago.class);
        return iGeneralService.savePago(pago);
    }

    @PostMapping("SavePedido")
    public String savePedido(@RequestBody String jsonPedido) throws JsonProcessingException {
    ...
    public String savePedidoDetalle(@RequestBody String jsonPedidoDetalle) throws JsonProcessingException {
    ...
    public String saveProducto(@RequestBody String jsonProducto) throws JsonProcessingException {
    ...
    public  String saveSede(@RequestBody String jsonSede) throws JsonProcessingException {
